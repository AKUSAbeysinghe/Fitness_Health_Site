...
// ================= WHATSAPP CONFIG =================
const WHATSAPP_NUMBER = "94712345678";   // ← Change this to your WhatsApp number (with country code)

const openWhatsApp = (message = "Hello, I'm interested in Supplements") => {
...
const SupplementsHeader = () => {
  ...
  const tabs = ["Overview", "Vitamins", "Immunity & Energy", "Sports Nutrition", "Herbal Wellness"];
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <button 
              onClick={() => openWhatsApp("Hi, I would like expert advice on supplements")}
    ...
    <div className="max-w-6xl mx-auto">
      <div className="rounded-[32px] bg-[#2E7D56] px-10 md:px-20 py-20 text-center text-white shadow-xl">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-5">
          ...
          {/* Updated WhatsApp Button */}
          <button 
            onClick={() => openWhatsApp("Hi, I would like a free nutrition consultation")}
...
const Supplements = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost/pharmacy-project/api/get_products.php?category_id=2");
  ...
  const immunityEnergy = products.filter(i =>
    i.sub_category_name?.toLowerCase().includes("immunity") ||
    i.sub_category_name?.toLowerCase().includes("energy") ||
    i.sub_category_name?.toLowerCase().includes("daily essential")
  );
  ...
  const sportsNutrition = products.filter(i =>
    ...
    i.sub_category_name?.toLowerCase().includes("nutrition")
  );
  ...
  return (
    <div className="bg-white">
      ...
      <ProductSection title="Vitamins & Minerals" subtitle="Daily essentials for immunity and energy." items={vitamins} bg="bg-white" />
      <ProductSection title="Immunity & Energy" subtitle="Daily essentials for immunity and energy." items={immunityEnergy} bg="bg-[#f7faf8]" />
      <ProductSection title="Sports Nutrition" subtitle="Fuel performance and recovery." items={sportsNutrition} bg="bg-white" />
      <ProductSection title="Herbal Wellness" subtitle="Natural support for balanced living." items={herbalWellness} bg="bg-[#f7faf8]" />
